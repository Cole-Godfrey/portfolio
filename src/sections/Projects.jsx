...
const Projects = () => {
    ...
    const text = `Projects that I've built through passion, creativity, and drive.`
    ...
    <section id="projects" className="min-h-screen flex flex-col">
        <AnimatedHeaderSection
            subTitle={"418 I brew code, not coffee."}
            title={"Projects"}
            text={text}
        ...
        >
            {projects.map((project, index) => (
                <a
                    ...
                    className="relative block flex flex-col gap-1 py-15 cursor-pointer group md:gap-0"
                ...
                >
                    ...
                    <div className="flex justify-between px-10 text-black transition-all duration-500 md:group-hover:px-12 md:group-hover:text-white">
                        ...
                        <Icon icon="lucide:arrow-up-right" width="24" height="24" className="md:size-6 size-5"/>
                    </div>
                    {/*Divider*/}
